...
from ai_notebook.config import LANGGRAPH_CHECKPOINT_FILE
from ai_notebook.domain.notebook import Source, SourceInsight
from ai_notebook.graphs.utils import provision_langchain_model
from ai_notebook.utils.context_builder import ContextBuilder
        ...
        try:
            ...
            return new_loop.run_until_complete(
                provision_langchain_model(
                    ...
                    "chat",
                    max_tokens=8192,
                    api_key=config.get("configurable", {}).get("request_api_key"),
                )
            )
        finally:
            new_loop.close()
