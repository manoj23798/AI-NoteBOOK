...
A flexible and generic ContextBuilder class for the AI Notebook project that can handle any parameters and build context from sources, notebooks, insights, and notes.
...
```python
from ai_notebook.utils.context_builder import ContextBuilder, ContextConfig
...
```python
from ai_notebook.utils.context_builder import (
...
```python
from ai_notebook.utils.context_builder import ContextConfig
...
```python
from ai_notebook.utils.context_builder import ContextItem
...
The ContextBuilder integrates seamlessly with the existing AI Notebook architecture:
