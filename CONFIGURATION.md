...
Starting from version 1.0.0-alpha, AI Notebook uses a simplified API connection system that automatically configures itself based on your deployment environment.
...
services:
  ai_notebook:
    image: manoj23798/ai_notebook:v1-latest
    ports:
      - "8502:8502"
...
docker run -e API_URL=http://your-server-ip:5055 \
  -p 8502:8502 \
  -p 5055:5055 \
  manoj23798/ai_notebook:v1-latest-single
```
