          ...
          {isCollapsed ? (
            ...
            <>
              <div className="flex items-center gap-2">
                <Image src="/logo.svg" alt="AI Notebook" width={32} height={32} />
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  ...
                  >
                    ...
                    <span className="sr-only">My Presentation</span>
                  </Button>
                </TooltipTrigger>
                <TooltipContent side="right">My Presentation</TooltipContent>
              </Tooltip>
            ) : (
              <Button
                variant="outline"
