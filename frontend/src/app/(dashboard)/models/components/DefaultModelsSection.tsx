  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Configure which models to use for different purposes across AI Notebook
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        {missingRequired.length > 0 && (
          <Alert>
            ...
            <AlertDescription>
              ...
              AI Notebook may not function properly without these.
            </AlertDescription>
          </Alert>
        )}
        ...
        <div className="pt-4 border-t">
          <a
            href="https://github.com/manoj23798/ai-notebook/blob/main/docs/features/ai-models.md"
            target="_blank"
