...
DOCKERHUB_IMAGE := manoj23798/ai_notebook
GHCR_IMAGE := ghcr.io/manoj23798/ai-notebook
...
# === Service Management ===
start-all:
	@echo "🚀 Starting AI Notebook (Database + API + Worker + Frontend)..."
...
stop-all:
	@echo "🛑 Stopping all AI Notebook services..."
...
status:
	@echo "📊 AI Notebook Service Status:"
