...
from ai_notebook.config import UPLOADS_FOLDER
from ai_notebook.database.repository import ensure_record_id, repo_query
from ai_notebook.domain.notebook import Notebook, Source
...
async def create_source_insight(source_id: str, request: CreateSourceInsightRequest):
    ...
    try:
        ...
        from ai_notebook.graphs.transformation import graph as transform_graph
