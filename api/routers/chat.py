...
from ai_notebook.domain.notebook import ChatSession, Note, Notebook, Source
from ai_notebook.exceptions import (
    NotFoundError,
)
from ai_notebook.graphs.chat import graph as chat_graph
...
async def build_context(request: BuildContextRequest):
    ...
    try:
        ...
        try:
            from ai_notebook.utils import token_count
