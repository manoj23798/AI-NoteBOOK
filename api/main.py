...
from ai_notebook.database.async_migrate import AsyncMigrationManager
...
app = FastAPI(
    ...
    description="API for AI Notebook - Research Assistant",
    version="0.2.2",
    lifespan=lifespan,
)
...
@app.get("/")
async def root():
    return {"message": "AI Notebook API is running"}
