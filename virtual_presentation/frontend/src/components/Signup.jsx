...
export default function Signup({ apiUrl, onSwitchToLogin }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const data = await res.text() // API returns text message string
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-black text-white p-4">
            <div className="w-full max-w-md p-8 bg-gray-900 rounded-2xl shadow-2xl border border-gray-800">
                ...
                {success && <div className="mb-4 p-3 bg-green-900/50 text-green-200 rounded border border-green-800 text-center">{success}</div>}
                ...
                <div className="mt-6 text-center text-gray-500">
                    ...
                    <button onClick={onSwitchToLogin} className="ml-2 text-purple-400 hover:text-purple-300">Sign In</button>
                </div>
            </div>
        </div>
    )
