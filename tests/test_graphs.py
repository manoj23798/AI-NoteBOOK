"""
Unit tests for the ai_notebook.graphs module.
...
from ai_notebook.graphs.prompt import PatternChainState, graph
from ai_notebook.graphs.tools import get_current_timestamp
from ai_notebook.graphs.transformation import (
    TransformationState,
    run_transformation,
)
from ai_notebook.graphs.transformation import (
...
class TestTransformationGraph:
    ...
    def test_transformation_state_structure(self):
        ...
        from ai_notebook.domain.notebook import Source
