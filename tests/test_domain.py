"""
Unit tests for the ai_notebook.domain module.
...
from ai_notebook.domain.base import RecordModel
from ai_notebook.domain.content_settings import ContentSettings
from ai_notebook.domain.models import ModelManager
from ai_notebook.domain.notebook import Note, Notebook, Source
from ai_notebook.domain.podcast import EpisodeProfile, SpeakerProfile
from ai_notebook.domain.transformation import Transformation
from ai_notebook.exceptions import InvalidInputError
...
class TestContentSettings:
    ...
    def test_content_settings_defaults(self):
        ...
        assert settings.record_id == "ai_notebook:content_settings"
