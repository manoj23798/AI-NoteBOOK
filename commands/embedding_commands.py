...
from ai_notebook.database.repository import ensure_record_id, repo_query
from ai_notebook.domain.models import model_manager
from ai_notebook.domain.notebook import Note, Source, SourceInsight
from ai_notebook.utils.text_utils import split_text
...
@command("embed_single_item", app="ai_notebook")
...
@command("vectorize_source", app="ai_notebook", retry=None)
...
@command("rebuild_embeddings", app="ai_notebook", retry=None)
